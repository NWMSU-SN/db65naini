...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Luggage App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Luggage App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Luggage App Login', user : req.user }); 
}); 
